package com.ntngel1.spacexlaunches.app.ui.screens.launches
...
import com.ntngel1.spacexlaunches.app.di.launches.RecyclerViewModule
import com.ntngel1.spacexlaunches.app.ui.screens.launches.recyclerview.LaunchesSceneController
...
class LaunchesFragment : MvpAppCompatFragment(), LaunchesView {
    ...
    private lateinit var component: LaunchesComponent
    ...
    @ProvidePresenter
    fun provideLaunchesPresenter() = component.presenter

    override fun onAttach(context: Context) {
        super.onAttach(context)
        component = App.appComponent.launchesComponentBuilder
            .recyclerViewModule(RecyclerViewModule(::onLoadMoreLaunches))
            .build()
    }
