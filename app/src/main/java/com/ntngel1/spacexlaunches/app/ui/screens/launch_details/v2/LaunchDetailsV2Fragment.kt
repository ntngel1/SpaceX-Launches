package com.ntngel1.spacexlaunches.app.ui.screens.launch_details.v2
...
import com.ntngel1.spacexlaunches.app.di.launch_details.v2.RecyclerViewModule
...
class LaunchDetailsV2Fragment : MvpAppCompatFragment(), LaunchDetailsView {

    private val args: LaunchDetailsV2FragmentArgs by navArgs()

    private lateinit var component: LaunchDetailsV2Component
    ...
    override fun onAttach(context: Context) {
        ...
        component = App.appComponent.launchDetailsV2ComponentBuilder
            .recyclerViewModule(
                RecyclerViewModule(
                    ::onImageClicked
                )
    ...
    private fun setupImagesRecyclerView() {
        ...
        imagesRecyclerView.addItemDecoration(component.carouselMarginItemDecoration)
